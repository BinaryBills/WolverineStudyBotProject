...
def convertUnitToSeconds(unit, time):
...
class remind(commands.Cog):
    ...
    async def remind(self,interaction: discord.Interaction, time : str,*, unit: str, task : str):
        ...
        converted_time = convertUnitToSeconds(unit, time)
        ...
        await interaction.followup.send(f"{interaction.user.mention} your reminder for **{task}** has finished!")
